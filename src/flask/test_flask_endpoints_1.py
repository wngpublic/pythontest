...
@app.route('/a/post-params-echo', methods=['POST'])
...
@app.route('/a/post-json-echo', methods=['POST'])
def post_json_echo():
    return flask.jsonify(flask.request.json)

@app.route('/a/get-json-echo', methods=['GET'])
def get_json_echo():
    return flask.jsonify(flask.request.json)

@app.route('/a/get-or-post-json-echo', methods=['GET','POST'])
...
if __name__ == "__main__":
    app.run(debug=True, port=8124) # default is port 5000
